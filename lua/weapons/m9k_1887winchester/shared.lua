if SERVER then
resource.AddFile("materials/vgui/ttt/1887winchester.png")
...
SWEP.Icon                   = "materials/vgui/ttt/1887winchester.png"
...
SWEP.Primary.Spread		    = .042	
SWEP.Primary.IronAccuracy   = .042	
